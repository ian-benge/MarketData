...
export const TICKER_META: Record<string, TickerMeta> = {
  ...
  XLB: { name: "Materials", group: "sector", heatmap: true },
  XLRE: { name: "Real estate", group: "sector", heatmap: true },
  XLC: { name: "Communication", group: "sector", heatmap: true },
  SMH: { name: "Semiconductors", group: "sector", heatmap: true },
  SHY: { name: "Short duration", group: "rates" },
  IEF: { name: "Intermediate duration", group: "rates" },
