...
| `DESK_INTEL_ENABLED` | Master switch for live desk intelligence model calls. Default `true` | No | No | ○ | ○ | ○ | You | Rules compilation still runs when false |
| `DESK_INTEL_IN_FIXTURES` | Allow model calls in demo/fixture mode. Default `false` | No | No | ○ | — | — | You | |
